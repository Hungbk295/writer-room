#!/usr/bin/env python3
"""
Generate inbox/_dictionary.tsv following Aswath Damodaran's decision-driven framework.
Covers 5 tables: dim_channel, fact_video, fact_keyword, fact_hook, dim_title_formula.
"""
...
ROWS = [
    ...
    [
        ...
        "Quyết định làm CỘT XẾP HẠNG CHÍNH để chọn chủ đề sản xuất vì do ta tự tính, hoàn toàn minh bạch và kiểm toán được.",
    ...
    [
        "fact_keyword", "top5_geos", "string", "",
        "Chuỗi văn bản liệt kê 5 quốc gia có tỷ trọng tìm kiếm từ khóa cao nhất kèm tỷ lệ phần trăm.",
        "CANDIDATE_FOR_REMOVAL",
    ...
    # =========================================================================
    # 5. dim_title_formula (14 columns)
    # =========================================================================
    [
...
def main():
    ...
    with open(DICT_PATH, "w", encoding="utf-8") as f:
        ...
        for r in ROWS:
            f.write("\t".join(r) + "\n")
    print(f"Wrote {len(ROWS)} rows to {DICT_PATH}")
